...
def test_rank_orders_relevant_result_first():
    results = [
        _result(
            "Unrelated cooking blog", "https://b.com", "recipes for soup and bread baking " * 20
        ),
        _result(
            "pgvector similarity guide",
            "https://a.com",
...
def test_rank_title_match_boosts_score():
    on_topic = _result("docker containers explained", "https://a.com", "general text " * 30)
