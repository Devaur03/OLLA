...
<button class="tab-btn" onclick="showTab('billing')">&#128179; Plan &amp; Billing</button>
</div>
...
document.querySelectorAll(".tab-btn")[name==="search"?0:1].classList.add("active");
...
const d=await apiPost(API+"/search",body);
